        ...
        <div className="flex flex-col items-center gap-6 mt-10 lg:flex-row lg:items-end lg:justify-center">
          {pricingTiers.map(({
            ...
            <div key={index} className={twMerge("card", inverse === true && "border-black bg-black text-white")} >
              ...
              <div className="flex items-baseline mt-[30px] gap-1 py-1">
                <span className="text-4xl font-bold tracking-tighter leading-none">${monthlyPrice}</span>
                <span className="text-black/50 tracking-tight font-bold">/month</span>
              </div>
              ...
              <ul className="flex flex-col gap-5 mt-8">
                {features.map((feature, index: any) => (
                  <li key={index} className="flex items-center text-sm gap-4">
