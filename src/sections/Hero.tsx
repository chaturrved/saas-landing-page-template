      ...
      <div className="container">
        <div className="md:flex items-center">
          <div className="md:w-[478px]">
            <div className="text-sm inline-flex border border-[#222]/60 px-3 py-1 rounded-lg tracking-tight">Version 2.0 is here</div>
          ...
          <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
            ...
            <Image src={cylinderImage} alt='Cylinder image' width={220} height={220} className="hidden md:block md:absolute -top-8 -left-32" />
